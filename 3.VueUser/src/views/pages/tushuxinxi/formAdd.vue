			...
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="图书编号" prop="tushubianhao">
						<el-input class="list_inp" v-model="form.tushubianhao" placeholder="请输入图书编号" readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="图书类型" prop="tushuleixing">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.tushuleixing?true:false"
							v-model="form.tushuleixing" 
							placeholder="请选择图书类型"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in tushuleixingLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
				...
				<el-col :span="24">
					<el-form-item label="图书详情" prop="tushuxiangqing">
						<editor class="list_editor" :value="form.tushuxiangqing" placeholder="请输入图书详情" :readonly="!isAdd||disabledForm.tushuxiangqing?true:false"
							@change="(e)=>editorChange(e,'tushuxiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.tushuxiangqing = res.data.data.tushuxiangqing.replace(reg,'../../../cl10195117/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='tushuleixing'){
					form.value.tushuleixing = row[x];
					disabledForm.value.tushuleixing = true;
					continue;
				}
				if(x=='fengmian'){
