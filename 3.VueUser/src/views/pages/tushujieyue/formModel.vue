	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"86%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">借阅编号</div>
					<div  class="info_text" >{{detail.jieyuebianhao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">图书名称</div>
					<div  class="info_text" >{{detail.tushumingcheng}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">借阅时间</div>
					<div  class="info_text" >{{detail.jieyueshijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">借阅方式</div>
					<div  class="info_text" >{{detail.jieyuefangshi}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('tushujieyue','审核')" type="warning" @click="approvalClick()">审核</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('tushujieyue','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('tushujieyue','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('tushujieyue','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.tushubianhao
