...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"86%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="8">
					<el-form-item label="借阅编号" prop="jieyuebianhao">
						<el-input class="list_inp" v-model="form.jieyuebianhao" placeholder="请输入借阅编号" readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="图书编号" prop="tushubianhao">
						<el-input class="list_inp" v-model="form.tushubianhao" placeholder="图书编号"
							 type="text" 							:readonly="!isAdd||disabledForm.tushubianhao?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="图书名称" prop="tushumingcheng">
						<el-input class="list_inp" v-model="form.tushumingcheng" placeholder="图书名称"
							 type="text" 							:readonly="!isAdd||disabledForm.tushumingcheng?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="8">
					<el-form-item label="出版社" prop="chubanshe">
						<el-input class="list_inp" v-model="form.chubanshe" placeholder="出版社"
							 type="text" 							:readonly="!isAdd||disabledForm.chubanshe?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="借阅时间" prop="jieyueshijian">
						<el-date-picker
							class="list_date"
				...
				<el-col :span="8">
					<el-form-item label="借阅方式" prop="jieyuefangshi">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.jieyuefangshi?true:false"
							v-model="form.jieyuefangshi" 
							placeholder="请选择借阅方式"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in jieyuefangshiLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
			form.value.jieyueshijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='jieyuebianhao'){
					form.value.jieyuebianhao = row[x];
					disabledForm.value.jieyuebianhao = true;
					continue;
				}
				if(x=='tushubianhao'){
				...
				if(x=='jieyueshijian'){
					form.value.jieyueshijian = row[x];
					disabledForm.value.jieyueshijian = true;
					continue;
				}
				if(x=='jieyuefangshi'){
					form.value.jieyuefangshi = row[x];
					disabledForm.value.jieyuefangshi = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
