<template>
	<div class="app-contain" :style='{"width":"86%","padding":"0px 20px 10px","margin":"30px auto 40px","position":"relative","borderRadius":"0px","background":"none"}'>
				...
				tr {
					...
					td {
						...
						.cell {
							...
							// 查看详情-悬浮
							.view_btn:hover {
								transform: rotate(0deg) scale(0.9) skew(0deg, 0deg) translate3d(0px, -2px, 0px);
							}
							// 删除
							.del_btn {
